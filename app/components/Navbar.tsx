...
const Navbar = () => {
    return ( 
        <div className=" fixed flex justify-center h-1/6 w-5/6 ">
            <div className="h-full w-full flex justify-center items-end flex-col">
                <div className = "h-full w-full flex flex-row items-center">
                    <div className = "h-4/6 w-2/12"><Image src={Logo} alt="Logo" className='h-full w-full' width="250" height="150"/></div>
